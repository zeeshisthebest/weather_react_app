...
import { ChartsReferenceLine, LineChart, lineClasses } from "@mui/x-charts";
...
const AirQualityGraph = ({ airQuality }) => (
    <LineChart
        {...lineChartOptions}
        series={[
            {
                ...
                area: true,
                data: [4, 4, 4, 4, 4, 4],
                showMark: ({ position }) => position === airQuality,
